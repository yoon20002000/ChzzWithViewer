...
namespace ChzzAPI
{
    public class ChzzkUnity : MonoBehaviour
    {
        ...
        private void Start()
        {
            onMessage.AddListener(DefaultMessage);
            onDonation.AddListener(DefaultDonation);
            onSubscription.AddListener(DefaultSubscription);
        }
        ...
        public async UniTask Connect(string channelId = default)
        {
            ...
            var sslProtocolHack =
                (System.Security.Authentication.SslProtocols)(SslProtocolsHack.Tls12 | SslProtocolsHack.Tls11 |
